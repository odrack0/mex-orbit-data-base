...
| `2026.09.03.1` | **Temporal**: el 1-1 se queda solo con la serie ACI; las nueve especies anteriores salen del reparto (siguen en el catálogo; el rollback devuelve sus cantidades) |
...
| `2026.09.02.2` | Renombre TEMPORAL `drony` → `aci-01` (code, especie y nombre visible) hasta decidir el nombre definitivo; va con `data/npcs/aci-01.json` y `assets/npcs/aci-01.glb` del cliente |
